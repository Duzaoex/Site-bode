    ...
    <section id="advantages" className={styles.advantages}>
      ...
      <div className={styles.advantage}>
        ...
        <p className={styles.p}>
          Nossos treinos e acompanhamentos são montados dentro de um APP exclusivo,
           desenvolvido especialmente para os nossos clientes. Nesse aplicativo, você 
           encontrará planos de treino personalizados, além de vídeos explicativos
            que mostram a execução correta de cada exercício. Isso não só maximiza seus 
            resultados, mas também garante que você treine com segurança.
        </p>
      </div>
      <div className={styles.advantage}>
        <div className={styles.icon}>💬</div>
        ...
        <p className={styles.p}>
          Dentro do APP, você terá acesso a suporte direto de André,
           onde poderá tirar dúvidas e receber orientações. 
           Isso significa que você não estará sozinho em sua jornada; terá 
           um acompanhamento constante para garantir que você esteja sempre
            no caminho certo.
        </p>
      </div>
      <div className={styles.advantage}>
