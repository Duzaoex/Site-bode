  ...
  return (
    <section id="testimonials" className={styles.testimonials}>
      ...
      <div className={styles.testimonial}>
        ...
        <p className={styles.p}>"Os treinos do André transformaram minha vida. Estou mais saudável e confiante!"</p>
      </div>
      <div className={styles.testimonial}>
        <img src="/src/Helpers/Antes e depois/WhatsApp Image 2024-09-14 at 06.53.59 (1).jpeg" alt="Cliente 2" />
        <p className={styles.p}>"O acompanhamento e a personalização dos treinos fazem toda a diferença!"</p>
      </div>
    </section>
  );
}
